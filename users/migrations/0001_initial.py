    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ManyToManyField(blank=True, null=True, related_name='targets', to=settings.AUTH_USER_MODEL, verbose_name='팔로워')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('target', models.ManyToManyField(blank=True, null=True, related_name='followers', to=settings.AUTH_USER_MODEL, verbose_name='팔로잉')),
